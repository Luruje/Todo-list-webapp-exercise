...
public class TaskController {
    ...
    public TaskController(final TaskRepository repository, ApplicationEventPublisher applicationEventPublisher) {
...
//    @RequestMapping(method = RequestMethod.GET, path = "/tasks")
    ...
    @PostMapping
    ResponseEntity<?> createTask(@RequestBody Task toPost){
